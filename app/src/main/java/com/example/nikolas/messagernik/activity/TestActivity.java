...
public class TestActivity extends AppCompatActivity {
    ...
    private Button btnCapturePicture, btnRecordVideo, btnGetUsers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        responseListener = new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                User user=null;
                //String  rightString= new String(response.getBytes("utf-8"),"windows-1251");
                try {
                    user =User.fromJson(new JSONObject(response));
        ...
        receiver = new Receiver(this,responseListener,errorListener);
        ...
        btnGetUsers.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                receiver.sendGetRequest(Config.SERVER_URL+"rest/user/3");
            }
        });
    ...
    private void launchUploadActivity(boolean isImage){
        Intent i = new Intent(TestActivity.this, UploadActivity.class);
